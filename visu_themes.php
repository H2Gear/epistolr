        ...
        <div class = "container">
            ...
            <div class "row">
				 ...
				 <p></br></br></br></br>
                    ...
                    <h2></br> Affichage des différents thèmes </br> Possibilité principale : ajouter une thèse associée</h2>
                    <?php
                    /*
                    ...
                    if (!isset($_SESSION['pseudo']) || !isset($_SESSION['id']) )
			{
                    ...
                    <p>Bienvenue dans l'espace permettant de visualiser les thèmes. Les thèmes seront filtrés par tags par la suite.<b><?php echo $pseudo . ' ! '; ?></b><br> voici vos informations</p>
                        <p>Thème 1 : </br>
